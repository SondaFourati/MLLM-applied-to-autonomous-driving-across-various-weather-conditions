...
class Model:
    ...
    def set_weather(self,cloudiness=80.0, precipitation=70.0, 
        ...
        if self.carlaSync:
            ...
            self.carlaSync.carla.world.set_weather(weather)
        else:
 ...
 #*******************************************************************************************************************************
    ...
    def start(self):
        ...
        if self.CARLACosim:
            ...
            #****************************************** Added*****************************************
            #self.set_weather(cloudiness=80.0, precipitation=70.0, precipitation_deposits=60.0, wind_intensity=30.0, sun_altitude_angle=45.0, fog_density=10.0, fog_distance=10.0, wetness=80.0)  # <-- Added line by sonda***hard Rain****************
            #self.set_weather(cloudiness=80.0, precipitation=100.0, precipitation_deposits=100.0, wind_intensity=100.0, sun_altitude_angle=20.0, fog_density=20.0, fog_distance=10.0, wetness=80.0)  # <-- Added line by sonda*****Storm***************
            #self.set_weather(cloudiness=40.0, precipitation=5.0, precipitation_deposits=5.0, wind_intensity=10.0, sun_altitude_angle=60.0, fog_density=70.0, fog_distance=3.0, wetness=10.0)  # <-- Added line by sonda***********Fog*******************
            #self.set_weather(cloudiness=30.0, precipitation=0.0, precipitation_deposits=0.0, wind_intensity=0.0, sun_altitude_angle=70.0, fog_density=0.0, fog_distance=0.0, wetness=100.0)  # <-- Added line by sonda*************Wetness*****************
            ...
            #self.set_weather(cloudiness=100.0, precipitation=90.0, precipitation_deposits=90.0, wind_intensity=80.0, sun_altitude_angle=10.0, fog_density=60.0, fog_distance=5.0, wetness=70.0)  # <-- Added line by sonda******************************
            #self.set_weather(cloudiness=00.0, precipitation=00.0, precipitation_deposits=00.0, wind_intensity=00.0, sun_altitude_angle=60.0, fog_density=00.0, fog_distance=20.0, wetness=00.0)  # <--good weather*****************************
            #****************************************** Added ***************************************
        else:
            return
